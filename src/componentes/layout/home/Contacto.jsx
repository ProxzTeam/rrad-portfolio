...
const Contacto = ({ language = 'en' }) => {
    ...
    const mensaje = language === 'es'
        ? 'Hola Danilo, quiero hablar sobre mi proyecto'
        : 'Hi Danilo, I want to talk about my project';
            ...
            <section className="contacto" id="contacto">
                <div className="contacto-contenido">
                    <div className="encabezado contacto-encabezado">
                        <h3 className="titulo">{language === 'es' ? 'Hagamos tu idea realidad' : 'Let us make your idea real'}</h3>
                        <p className="subtitulo">{language === 'es' ? 'Escribeme directamente por WhatsApp.' : 'Message me directly on WhatsApp.'}</p>
                    </div>
                    ...
                    <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="boton contacto-whatsapp">
                        ...
                        <span>{language === 'es' ? 'Hablar por WhatsApp' : 'Chat on WhatsApp'}</span>
                        <div className="icono" aria-hidden="true">
